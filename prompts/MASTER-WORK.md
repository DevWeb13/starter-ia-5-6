...
Copiez, remplacez les champs entre crochets et lancez dans Work.

```text
Résultat attendu : [résultat concret].
Livrables : [fichiers, liens ou réponse].
Contexte utile : [faits et éléments fournis].
Contraintes : [délais, format, limites].
Réussite vérifiée si : [contrôles observables].

Tu es l’orchestrateur et l’unique écrivain. Lance au maximum trois sous-agents, surtout en lecture seule, pour analyser des angles distincts. Synthétise leurs avis, présente un plan, puis exécute.
